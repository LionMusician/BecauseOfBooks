        ...
        <div class="infoDiv">
            <div class="topDiv">
                <div class="imgDiv">
                    ...
                    <!-- <img class="stage" v-if="userInfo.stage" :src="'../../static/images/userInfo/start_1.jpg'"> -->
                </div>
                <div class="stage">
                    <img
                        v-if="userInfo.stage"
                        :src="'../../static/images/userInfo/start_'+ userInfo.stage +'.jpg'"
                    />
                </div>
                <div class="info">
                    <div class="top">
        ...
        listClick(item) {
            ...
            switch (item.value) {
                ...
                case 10: // 我的地址
                    ...
                    break;
                case 11: // 成长记录卡
                    wx.navigateTo("/pages/user/growthRecord/main");
                    break;
            }
        },
        // 账号管理
