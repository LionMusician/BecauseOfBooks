		...
		<div class="main" @click="bookClick">
			...
			<div class="right">
				...
				<div class="bottom">
					...
					<div class="btns">
						<p class="read-count-no" v-if="!book.remainStock">库存不足</p>
						...
						<div :class="book.remainStock ? 'add' : 'add disabled'" @click.stop="addBookToBag(book)">
	...
	.main {
		...
		.right {
			...
			.name {
				...
				height: 100rpx;
				line-height: 40rpx;
				@include sc($--text-l, $--color-gray-6);
				@include ellipsis2;
			}
			.tag-list {
				@include hh(60rpx);
